...
final coinsFutureProvider = FutureProvider((ref) async {
  final coinsList = await ref.watch(clientProvider).getCoins();
  return coinsList;
});

final coinsCacheProvider = StateProvider<List<Coins>>((ref) => []);

final loadingProvider = StateProvider<bool>((ref) => false);

final clientProvider = Provider<CoinsApiService>((ref) {
  return CoinsApiService();
});
