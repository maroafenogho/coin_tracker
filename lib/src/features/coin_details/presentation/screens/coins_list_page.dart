...
import 'package:coin_tracker/src/features/coin_details/presentation/screens/coin_details.dart';
      ...
      body: Consumer(builder: (((context, ref, child) {
        ...
        return asyncCoins.when(
          ...
          data: (coin) {
            ...
            //     ref.read(timerProvider.notifier).state = 10;

            //     timer.cancel;
            //   }
            // });
            return RefreshIndicator(
              onRefresh: () => ref.watch(asyncCoinProvider.notifier).getCoins(),
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          ref
                                              .read(selectedCoin.notifier)
                                              .state = coinmodel;
                                          ref
                                              .read(asyncChartProvider.notifier)
                                              .getCoinChart(
